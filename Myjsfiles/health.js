...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("https://newsapi-w6iw.onrender.com/api/news/category/health")
  ...
  `;
          ...
          items.addEventListener("click", () => {
            ...
            if (slug) {
              window.location.href = `../detail/healthdetail.html?id=${slug}`;
            }
          });
          healthcontainer.appendChild(items);
          console.log(items);
        });
      };
      ...
      setInterval(() => {
        fade(healthcontainer, "out");
        setTimeout(() => {
          display = display === 0 ? 5 : 0;
          rendernews(display);
          fade(healthcontainer, "in");
        }, 600);
      }, 8000);
    })
