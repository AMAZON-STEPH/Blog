...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("https://newsapi-w6iw.onrender.com/api/news/category/culture")
  ...
  `;
          ...
          items.addEventListener("click", () => {
            ...
            if (slug) {
              window.location.href = `../detail/culturedetail.html?id=${slug}`;
            }
          });
          culturecontainer.appendChild(items);
          console.log(items);
        });
      };
      ...
      setInterval(() => {
        fade(culturecontainer, "out");
        setTimeout(() => {
          display = display === 0 ? 5 : 0;
          rendernews(display);
          fade(culturecontainer, "in");
        }, 600);
      }, 8000);
    })
