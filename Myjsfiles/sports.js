...
document.addEventListener("DOMContentLoaded", () => {
  ...
  fetch("https://newsapi-w6iw.onrender.com/api/news/category/sports")
  ...
  `;
          ...
          items.addEventListener("click", () => {
            ...
            if (slug) {
              window.location.href = `../detail/sportsdetail.html?id=${slug}`;
            }
          });
         sportscontainer.appendChild(items);
          console.log(items);
        });
      };
      ...
      setInterval(() => {
        fade(sportscontainer, "out");
        setTimeout(() => {
          display = display === 0 ? 5 : 0;
          rendernews(display);
          fade(sportscontainer, "in");
        }, 600);
      }, 8000);
    })
